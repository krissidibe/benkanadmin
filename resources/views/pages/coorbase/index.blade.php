...
@endif
                  ...
                  <div class="x_title">
                    <h2>Liste des comités de base </h2>
              ...
              <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 63px;" aria-label="Age: activate to sort column ascending">Commune</th>
                          <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 63px;" aria-label="Age: activate to sort column ascending">Quartier</th>
                     ...
                     @foreach ($datas as $item )
                        <tr role="row" class="odd">
                          ...
                          <td tabindex="0" class="sorting_1">{{$item->region}}</td>
                          <td>{{$item->cercle}}</td>
                          <td>{{$item->commune}}</td>
                          <td>{{$item->quartier}}</td>
                          <td>{{$item->prenom}}</td>
                          <td>{{$item->nom}}</td>
                          <td> <a href="{{ route('admin.coorbase.show', [$item]) }}">Afficher</a> </td>
